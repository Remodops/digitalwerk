...
export const metadata = withPageMeta({
  title: "Digitalwerk",
  description: "Go‑Live in 2–3 Wochen: klare Prozesse, saubere Technik und messbare Performance – ohne Agentur‑Overhead.",
});
...
export default function Page() {
  return (
    <>
      <Hero />
      <Section title="Warum Digitalwerk?" subtitle="Was Sie konkret davon haben – die 3 Säulen unseres Angebots." className="py-10 sm:py-12">
        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-3 text-sm text-neutral-800">
          ...
          <li className="rounded-lg border p-4">
            ...
            <p className="mt-1 text-neutral-700">Ein Ansprechpartner. Klare Prozesse. Keine Reibungsverluste.</p>
          </li>
        </ul>
      </Section>
      <Section title="Leistungsteaser" subtitle="Kurzüberblick – Details auf der Leistungsseite." className="bg-neutral-50 py-10 sm:py-12">
      ...
      <Section className="py-8 sm:py-10" title="Bereit für den nächsten Schritt?" subtitle="20 Minuten Call – Ziel, Umfang, Festpreis.">
      ...
      <Section title="Ausgewählte Projekte" subtitle="Einblick in Ergebnisse." className="bg-neutral-50 py-10 sm:py-12">
        <Container>
          <HighlightCases items={cases.slice(-2).reverse()} />
        </Container>
      </Section>
      {/* Vertrauen-Sektion entfernt */}
      <Section title="Lass uns deine Website live bringen." subtitle="20 Minuten Call – Ziel, Umfang, Festpreis." className="py-8 sm:py-10">
        <div className="flex flex-wrap items-center gap-3">
